...
import { ClickTypeDetector } from '../services/click-type-detector.js'
...
export function createContainer() {
  ...
  const clickTypeDetector = new ClickTypeDetector(editor)
  ...
  return {
    host, plugin, editor, sdt, link, wordart, shape, table, selectionBinding, elementDetection, chartBinding, clickTypeDetector,
